...
function headerChange() {
  if ((document.body.scrollTop > 80 && document.body.scrollTop < home_bac.offsetHeight-50)|| (document.documentElement.scrollTop > 80 && document.documentElement.scrollTop < home_bac.offsetHeight-50)) {
    ...
    top_nav.classList.add('top-nav-bgcolor1');
    top_nav.classList.remove('top-nav-bgcolor2');
    top_nav_btns.forEach(top_nav_btn => {
      top_nav_btn.classList.add('top-nav-bgcolor1-text');
      top_nav_btn.classList.remove('top-nav-bgcolor2-text');
    }); 
  ...
  top_nav.classList.remove('top-nav-bgcolor1');
  top_nav.classList.add('top-nav-bgcolor2');
  top_nav_btns.forEach(top_nav_btn => {
    top_nav_btn.classList.remove('top-nav-bgcolor1-text');
    top_nav_btn.classList.add('top-nav-bgcolor2-text');
  });
...
function aboutServiceTextEffect(){
  ...
  if ((document.body.scrollTop > text_change_point )|| (document.documentElement.scrollTop > text_change_point )) {
    about_service_header_text.innerHTML = '<span class="dubbing-icons">🎧</span> Dubbing Artist <span class="dubbing-icons">🎧</span>';
